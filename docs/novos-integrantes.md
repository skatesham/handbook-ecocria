...
|-------|------|------------------|
| 1. Ambientação | Cultura + segurança | Conhece ritmos, espaço e EPIs |
| 2. Fundamentos | Madeira & acabamentos básicos | Executa cortes/lixas simples com precisão |
| 3. Produção assistida | Execução guiada | Entrega etapas de peças com supervisão leve |
| 4. Domínio das ferramentas | Técnica e estética | Uso seguro de ferramentas elétricas leves |
| 5. CNC & Laser (opcional) | Tecnologia de apoio | Configura arquivos simples e entende parâmetros |
| 6. Produção independente | Autonomia operacional | Planeja, produz e confere qualidade sozinho |
| 7. Criatividade guiada | Evolução de produtos | Ajusta modelos e testa variações com propósito |
| 8. Autonomia criativa | Liderança técnica | Cria protótipos e orienta novas pessoas |
